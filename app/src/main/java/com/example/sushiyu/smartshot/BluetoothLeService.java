...
//        	mBluetoothGatt.setCharacteristicNotification(jdy, p);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            String intentAction;
            Log.e("mcfire_sushiyu", "status "+status);
            Log.e("mcfire_sushiyu", "newState "+newState);
    ...
    public void disconnect() {
        ...
        Log.w(TAG, "BluetoothLeService disconnected mBluetoothDeviceAddress = "+mBluetoothDeviceAddress);
    }
